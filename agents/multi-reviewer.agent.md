...
- **Code Quality & Clean Code**: Fetch `skills/code-quality/SKILL.md` from `JOHNEPPILLAR/the-synth-eng-skills` through Pandora's Box.
- **Security Best Practices**: Fetch `skills/security-best-practices/SKILL.md` from `JOHNEPPILLAR/the-synth-eng-skills` through Pandora's Box.
- **Testing & QA**: Fetch `skills/testing-qa/SKILL.md` from `JOHNEPPILLAR/the-synth-eng-skills` through Pandora's Box.
