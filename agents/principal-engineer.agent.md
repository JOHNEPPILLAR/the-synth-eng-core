...
- If coverage or vulnerability tooling is unavailable, report that explicitly as a blocker or limitation rather than silently skipping it.
...
When invoked after SoftwareEngineer escalation, you will receive:

- original task
- Planner plan
- SoftwareEngineer output
