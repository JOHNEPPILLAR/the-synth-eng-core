...
1. fetch `skills/testing-qa/SKILL.md` from `JOHNEPPILLAR/the-synth-eng-skills` through Pandora's Box
2. fetch `skills/code-quality/SKILL.md` from `JOHNEPPILLAR/the-synth-eng-skills` through Pandora's Box when verification scope depends on changed-risk assessment
