...
- PrincipalEngineer is performing a **high-risk refactoring** that needs rollback safety
...
Worktree A:        wt/feature-auth   → PrincipalEngineer works on auth
Worktree B:        wt/feature-dashboard → PrincipalEngineer works on dashboard
```
...
Worktree refactor: wt/refactor-api-v2 → PrincipalEngineer performs refactoring
```
